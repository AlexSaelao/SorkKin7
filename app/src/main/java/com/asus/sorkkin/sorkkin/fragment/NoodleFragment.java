...
public class NoodleFragment extends Fragment {
    ...
    NoodleFragment.MyAdapter adapter;
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("restaurants/noodle");
        mDatabase.keepSynced(true);

        mPhotoListItem = (RecyclerView) rootView.findViewById(R.id.recycleViewNoodle);
        ...
        adapter = new NoodleFragment.MyAdapter(listphotolist);
    ...
    public class MyAdapter extends RecyclerView.Adapter<NoodleFragment.MyAdapter.MyViewHolder> {
        ...
        @NonNull
        @Override
        public NoodleFragment.MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            return new NoodleFragment.MyAdapter.MyViewHolder(view);
        }

        @Override
        public void onBindViewHolder(NoodleFragment.MyAdapter.MyViewHolder holder, int position) {
            ...
            holder.rootView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    NoodleFragment.FragmentListener listener = (NoodleFragment.FragmentListener) getActivity();
