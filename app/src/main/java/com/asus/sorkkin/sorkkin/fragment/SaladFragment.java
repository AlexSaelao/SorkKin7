...
public class SaladFragment extends Fragment {
    ...
    SaladFragment.MyAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_salad, container, false);
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("restaurants/salad");
        mDatabase.keepSynced(true);

        mPhotoListItem = (RecyclerView) rootView.findViewById(R.id.recycleViewSalad);
        ...
        adapter = new SaladFragment.MyAdapter(listphotolist);
    ...
    public class MyAdapter extends RecyclerView.Adapter<SaladFragment.MyAdapter.MyViewHolder> {
        ...
        @NonNull
        @Override
        public SaladFragment.MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            return new SaladFragment.MyAdapter.MyViewHolder(view);
        }

        @Override
        public void onBindViewHolder(SaladFragment.MyAdapter.MyViewHolder holder, int position) {
            ...
            holder.roootView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    PhotoList dao = listphotolist.get(itemPosition);
                    SaladFragment.FragmentListener listener = (SaladFragment.FragmentListener) getActivity();
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            public MyViewHolder(View itemView) {
                ...
                roootView = (View) itemView.findViewById(R.id.rootView);
            }
        }
