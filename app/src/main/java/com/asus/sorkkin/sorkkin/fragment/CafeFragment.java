...
public class CafeFragment extends Fragment {
    ...
    CafeFragment.MyAdapter adapter;
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("restaurants/cafe");
        mDatabase.keepSynced(true);

        mPhotoListItem = (RecyclerView) rootView.findViewById(R.id.recycleViewCafe);
        ...
        adapter = new CafeFragment.MyAdapter(listphotolist);
    ...
    public class MyAdapter extends RecyclerView.Adapter<CafeFragment.MyAdapter.MyViewHolder> {
        ...
        @NonNull
        @Override
        public CafeFragment.MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            return new CafeFragment.MyAdapter.MyViewHolder(view);

        }

        @Override
        public void onBindViewHolder(final CafeFragment.MyAdapter.MyViewHolder holder, int position) {
            final PhotoList photoList = listArray.get(position);
            ...
            Log.e("BindView", "img: " + photoList.getImg());
